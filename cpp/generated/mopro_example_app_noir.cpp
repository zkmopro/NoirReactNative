...
// it!
#include "mopro_example_app_noir.hpp"
...
RustBuffer uniffi_mopro_example_app_noir_fn_func_generate_circom_proof(
    RustBuffer _zkey_path, RustBuffer _circuit_inputs, RustBuffer _proof_lib,
    RustCallStatus *uniffi_out_err);
RustBuffer uniffi_mopro_example_app_noir_fn_func_generate_halo2_proof(
    RustBuffer _srs_path, RustBuffer _pk_path, RustBuffer _circuit_inputs,
    RustCallStatus *uniffi_out_err);
RustBuffer uniffi_mopro_example_app_noir_fn_func_generate_noir_proof(
    RustBuffer circuit_path, RustBuffer srs_path, RustBuffer inputs,
    int8_t on_chain, RustBuffer vk, int8_t low_memory_mode,
    RustCallStatus *uniffi_out_err);
RustBuffer uniffi_mopro_example_app_noir_fn_func_get_noir_verification_key(
    RustBuffer circuit_path, RustBuffer srs_path, int8_t on_chain,
    int8_t low_memory_mode, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_mopro_example_app_noir_fn_func_mopro_hello_world(
    RustCallStatus *uniffi_out_err);
int8_t uniffi_mopro_example_app_noir_fn_func_verify_circom_proof(
    RustBuffer _zkey_path, RustBuffer _proof_result, RustBuffer _proof_lib,
    RustCallStatus *uniffi_out_err);
int8_t uniffi_mopro_example_app_noir_fn_func_verify_halo2_proof(
    RustBuffer _srs_path, RustBuffer _vk_path, RustBuffer _proof,
    RustBuffer _public_input, RustCallStatus *uniffi_out_err);
int8_t uniffi_mopro_example_app_noir_fn_func_verify_noir_proof(
    RustBuffer circuit_path, RustBuffer proof, int8_t on_chain, RustBuffer vk,
    int8_t low_memory_mode, RustCallStatus *uniffi_out_err);
RustBuffer
ffi_mopro_example_app_noir_rustbuffer_alloc(uint64_t size,
                                            RustCallStatus *uniffi_out_err);
RustBuffer ffi_mopro_example_app_noir_rustbuffer_from_bytes(
    ForeignBytes bytes, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rustbuffer_free(RustBuffer buf,
                                                RustCallStatus *uniffi_out_err);
RustBuffer ffi_mopro_example_app_noir_rustbuffer_reserve(
    RustBuffer buf, uint64_t additional, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_mopro_example_app_noir_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_mopro_example_app_noir_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_mopro_example_app_noir_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_mopro_example_app_noir_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_mopro_example_app_noir_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_mopro_example_app_noir_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_mopro_example_app_noir_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_mopro_example_app_noir_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_mopro_example_app_noir_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_mopro_example_app_noir_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_mopro_example_app_noir_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_mopro_example_app_noir_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_mopro_example_app_noir_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_mopro_example_app_noir_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_mopro_example_app_noir_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_mopro_example_app_noir_checksum_func_generate_circom_proof();
uint16_t uniffi_mopro_example_app_noir_checksum_func_generate_halo2_proof();
uint16_t uniffi_mopro_example_app_noir_checksum_func_generate_noir_proof();
uint16_t
uniffi_mopro_example_app_noir_checksum_func_get_noir_verification_key();
uint16_t uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world();
uint16_t uniffi_mopro_example_app_noir_checksum_func_verify_circom_proof();
uint16_t uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof();
uint16_t uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof();
uint32_t ffi_mopro_example_app_noir_uniffi_contract_version();
}

namespace uniffi::mopro_example_app_noir {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::mopro_example_app_noir::Bridging<T>::fromJs(
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_mopro_example_app_noir_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_mopro_example_app_noir_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_mopro_example_app_noir_rustbuffer_from_bytes(bytes, &status);
  }
...
namespace uniffi::mopro_example_app_noir::registry {
...
// Callback function:
// uniffi::mopro_example_app_noir::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::mopro_example_app_noir::cb::rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::mopro_example_app_noir::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
// This method is called from the destructor of NativeMoproExampleAppNoir, which
...
static void cleanup() {
  ...
  // uniffi::mopro_example_app_noir::cb::rustfuturecontinuationcallback
...
// Callback function:
// uniffi::mopro_example_app_noir::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::mopro_example_app_noir::st::foreignfuture::foreignfuture::
    free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::mopro_example_app_noir::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
static void cleanup() {
  ...
  // uniffi::mopro_example_app_noir::st::foreignfuture::foreignfuture::free
namespace uniffi::mopro_example_app_noir {
using namespace facebook;
using CallInvoker = uniffi_runtime::UniffiCallInvoker;
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::mopro_example_app_noir::st::foreignfuture::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status =
        uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::mopro_example_app_noir::Bridging<
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.return_value =
        uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status =
        uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::mopro_example_app_noir::cb::
...
NativeMoproExampleAppNoir::NativeMoproExampleAppNoir(
    jsi::Runtime &rt,
  ...
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_generate_circom_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_fn_"
                                        "func_generate_circom_proof"),
          3,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_fn_func_generate_circom_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_generate_halo2_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_fn_"
                                        "func_generate_halo2_proof"),
          3,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_fn_func_generate_halo2_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_generate_noir_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_mopro_example_app_noir_fn_func_generate_noir_proof"),
          6,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_fn_func_generate_noir_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_get_noir_verification_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_mopro_example_app_noir_fn_func_get_noir_verification_key(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_mopro_hello_world"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_mopro_example_app_noir_fn_func_mopro_hello_world"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_fn_func_mopro_hello_world(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_verify_circom_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_mopro_example_app_noir_fn_func_verify_circom_proof"),
          3,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_fn_func_verify_circom_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_verify_halo2_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_mopro_example_app_noir_fn_func_verify_halo2_proof"),
          4,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_fn_func_verify_halo2_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_fn_func_verify_noir_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_mopro_example_app_noir_fn_func_verify_noir_proof"),
          5,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_fn_func_verify_noir_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_circom_"
        "proof"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
                                    "checksum_func_generate_circom_proof"),
      0,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_mopro_example_app_noir_checksum_func_generate_circom_proof(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_halo2_"
        "proof"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_mopro_example_app_noir_checksum_func_generate_halo2_proof(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_noir_"
        "proof"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_mopro_example_app_noir_checksum_func_generate_noir_proof(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_get_noir_"
        "verification_key"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
                                    "checksum_func_get_noir_verification_key"),
      0,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_mopro_example_app_noir_checksum_func_get_noir_verification_key(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
                                        "checksum_func_mopro_hello_world"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_circom_"
        "proof"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_mopro_example_app_noir_checksum_func_verify_circom_proof(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
                                        "checksum_func_verify_halo2_proof"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_mopro_example_app_noir_"
                                        "checksum_func_verify_noir_proof"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof(
                    rt, thisVal, args, count);
          });
  props["ubrn_ffi_mopro_example_app_noir_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_mopro_example_app_noir_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_mopro_example_app_noir_uniffi_contract_version(
                rt, thisVal, args, count);
          });
}

void NativeMoproExampleAppNoir::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeMoproExampleAppNoir>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeMoproExampleAppNoir", obj);
}

void NativeMoproExampleAppNoir::unregisterModule(jsi::Runtime &rt) {
  uniffi::mopro_example_app_noir::registry::clearRegistry();
}

jsi::Value NativeMoproExampleAppNoir::get(jsi::Runtime &rt,
...
NativeMoproExampleAppNoir::getPropertyNames(jsi::Runtime &rt) {
...
void NativeMoproExampleAppNoir::set(jsi::Runtime &rt,
                                    const jsi::PropNameID &name,
                                    const jsi::Value &value) {
...
NativeMoproExampleAppNoir::~NativeMoproExampleAppNoir() {
  ...
  uniffi::mopro_example_app_noir::cb::rustfuturecontinuationcallback::cleanup();
...
jsi::Value NativeMoproExampleAppNoir::
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_fn_func_generate_circom_proof(
        ...
        size_t count) {
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_generate_circom_proof(
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
      ...
      &status);
  uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi::mopro_example_app_noir::Bridging<RustBuffer>::toJs(
...
jsi::Value NativeMoproExampleAppNoir::
  ...
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_generate_halo2_proof(
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
...
jsi::Value NativeMoproExampleAppNoir::
  ...
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_generate_noir_proof(
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
...
jsi::Value NativeMoproExampleAppNoir::
  ...
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_get_noir_verification_key(
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
...
jsi::Value NativeMoproExampleAppNoir::
  ...
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_mopro_hello_world(&status);
  uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);
...
jsi::Value NativeMoproExampleAppNoir::
  ...
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_verify_circom_proof(
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
...
jsi::Value NativeMoproExampleAppNoir::
  ...
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_verify_halo2_proof(
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
...
jsi::Value NativeMoproExampleAppNoir::
  ...
  RustCallStatus status =
      uniffi::mopro_example_app_noir::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_mopro_example_app_noir_fn_func_verify_noir_proof(
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::mopro_example_app_noir::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_checksum_func_generate_circom_proof(
        ...
        size_t count) {
  auto value =
      uniffi_mopro_example_app_noir_checksum_func_generate_circom_proof();
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_checksum_func_generate_halo2_proof(
        ...
        size_t count) {
  auto value =
      uniffi_mopro_example_app_noir_checksum_func_generate_halo2_proof();
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_checksum_func_generate_noir_proof(
        ...
        size_t count) {
  auto value =
      uniffi_mopro_example_app_noir_checksum_func_generate_noir_proof();
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world();
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_checksum_func_verify_circom_proof(
        ...
        size_t count) {
  auto value =
      uniffi_mopro_example_app_noir_checksum_func_verify_circom_proof();
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof();
...
jsi::Value NativeMoproExampleAppNoir::
    cpp_uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeMoproExampleAppNoir::
    cpp_ffi_mopro_example_app_noir_uniffi_contract_version(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = ffi_mopro_example_app_noir_uniffi_contract_version();
