...
export * from './generated/mopro_example_app_noir';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as mopro_example_app_noir from './generated/mopro_example_app_noir';
...
if (!initialized) {
  mopro_example_app_noir.default.initialize();
  initialized = true;
}
