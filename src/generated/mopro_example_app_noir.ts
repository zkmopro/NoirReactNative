...
} from "./mopro_example_app_noir-ffi";
import {
...
export function generateCircomProof(zkeyPath: string, circuitInputs: string, proofLib: ProofLib): CircomProofResult /*throws*/ {
    return FfiConverterTypeCircomProofResult.lift(
        uniffiCaller.rustCallWithError(
            ...
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_generate_circom_proof(
...
export function generateHalo2Proof(srsPath: string, pkPath: string, circuitInputs: Map<string, Array<string>>): Halo2ProofResult /*throws*/ {
    return FfiConverterTypeHalo2ProofResult.lift(
        uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_generate_halo2_proof(
...
export function generateNoirProof(circuitPath: string, srsPath: string | undefined, inputs: Array<string>, onChain: boolean, vk: ArrayBuffer, lowMemoryMode: boolean): ArrayBuffer /*throws*/ {
    return FfiConverterArrayBuffer.lift(
        uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_generate_noir_proof(
...
export function getNoirVerificationKey(circuitPath: string, srsPath: string | undefined, onChain: boolean, lowMemoryMode: boolean): ArrayBuffer /*throws*/ {
    return FfiConverterArrayBuffer.lift(
        uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_get_noir_verification_key(
        FfiConverterString.lower(circuitPath),
        FfiConverterOptionalString.lower(srsPath),
        FfiConverterBool.lower(onChain),
        FfiConverterBool.lower(lowMemoryMode),
...
export function moproHelloWorld(): string {
    return FfiConverterString.lift(uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_mopro_hello_world(
                callStatus);
            },
            /*liftString:*/ FfiConverterString.lift,
    ));
...
export function verifyCircomProof(zkeyPath: string, proofResult: CircomProofResult, proofLib: ProofLib): boolean /*throws*/ {
    return FfiConverterBool.lift(
        uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_verify_circom_proof(
        FfiConverterString.lower(zkeyPath),
...
export function verifyHalo2Proof(srsPath: string, vkPath: string, proof: ArrayBuffer, publicInput: ArrayBuffer): boolean /*throws*/ {
    return FfiConverterBool.lift(
        uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_verify_halo2_proof(
        FfiConverterString.lower(srsPath),
...
export function verifyNoirProof(circuitPath: string, proof: ArrayBuffer, onChain: boolean, vk: ArrayBuffer, lowMemoryMode: boolean): boolean /*throws*/ {
    return FfiConverterBool.lift(
        uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_mopro_example_app_noir_fn_func_verify_noir_proof(
        FfiConverterString.lower(circuitPath),
        FfiConverterArrayBuffer.lower(proof),
        FfiConverterBool.lower(onChain),
        FfiConverterArrayBuffer.lower(vk),
...
export const CircomProof = (() => {
    ...
    return Object.freeze({
         ...
         * in Rust, in the {@link mopro_example_app_noir} crate.
         */
        create,
        ...
        /**
         * Defaults specified in the {@link mopro_example_app_noir} crate.
         */
...
function uniffiEnsureInitialized() {
    ...
    const scaffoldingContractVersion = nativeModule().ubrn_ffi_mopro_example_app_noir_uniffi_contract_version();
    if (bindingsContractVersion !== scaffoldingContractVersion) {
        throw new UniffiInternalError.ContractVersionMismatch(scaffoldingContractVersion, bindingsContractVersion);
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_circom_proof() !== 55170) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_generate_circom_proof");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_halo2_proof() !== 65476) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_generate_halo2_proof");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_noir_proof() !== 22778) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_generate_noir_proof");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_get_noir_verification_key() !== 34545) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_get_noir_verification_key");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world() !== 15319) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_circom_proof() !== 63817) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_verify_circom_proof");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof() !== 55722) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof() !== 51044) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof");
    }
