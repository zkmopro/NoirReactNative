...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_mopro_example_app_noir_fn_func_generate_circom_proof(zkeyPath: Uint8Array, circuitInputs: Uint8Array, proofLib: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_mopro_example_app_noir_fn_func_generate_halo2_proof(srsPath: Uint8Array, pkPath: Uint8Array, circuitInputs: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_mopro_example_app_noir_fn_func_generate_noir_proof(circuitPath: Uint8Array, srsPath: Uint8Array, inputs: Uint8Array, onChain: number, vk: Uint8Array, lowMemoryMode: number, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_mopro_example_app_noir_fn_func_get_noir_verification_key(circuitPath: Uint8Array, srsPath: Uint8Array, onChain: number, lowMemoryMode: number, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_mopro_example_app_noir_fn_func_mopro_hello_world(uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_mopro_example_app_noir_fn_func_verify_circom_proof(zkeyPath: Uint8Array, proofResult: Uint8Array, proofLib: Uint8Array, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_mopro_example_app_noir_fn_func_verify_halo2_proof(srsPath: Uint8Array, vkPath: Uint8Array, proof: Uint8Array, publicInput: Uint8Array, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_mopro_example_app_noir_fn_func_verify_noir_proof(circuitPath: Uint8Array, proof: Uint8Array, onChain: number, vk: Uint8Array, lowMemoryMode: number, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_circom_proof(): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_halo2_proof(): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_generate_noir_proof(): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_get_noir_verification_key(): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_mopro_hello_world(): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_circom_proof(): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_halo2_proof(): number;
    ubrn_uniffi_mopro_example_app_noir_checksum_func_verify_noir_proof(): number;
    ubrn_ffi_mopro_example_app_noir_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeMoproExampleAppNoir`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeMoproExampleAppNoir` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () => (globalThis as any).NativeMoproExampleAppNoir;
